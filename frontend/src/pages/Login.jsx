  ...
  return (
    <div className="rego-container">
      ...
      >
        ...
        <h2 className="rego-title">Welcome to Re-Go</h2>
        <p className="rego-subtitle">Sign in to access your Travel Desk portal</p>
        ...
        >
          <motion.div variants={{ hidden: { opacity: 0, y: 8 }, visible: { opacity: 1, y: 0 } }}>
            <label className="rego-label">Email</label>
            <input className="rego-input" type="email" />
          </motion.div>

          <motion.div variants={{ hidden: { opacity: 0, y: 8 }, visible: { opacity: 1, y: 0 } }}>
            <label className="rego-label">Password</label>
            <input className="rego-input" type="password" />
          </motion.div>
